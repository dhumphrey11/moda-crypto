...
# Setup GCP for existing Moda Crypto project (Skip billing check)
...
echo "1️⃣ Setting project as default..."
...
echo ""
echo "4️⃣ Granting necessary roles..."
ROLES=(
    "roles/run.admin"
    "roles/storage.admin" 
...
echo ""
echo "6️⃣ Setting up GitHub secrets..."
